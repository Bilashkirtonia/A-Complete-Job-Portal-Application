...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h2>{{ $page_other_data->login_page_heading }}</h2>
        </div>
    </div>
</div>
</div>
            ...
            <div class="login-form">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div
                        ...
                        tabindex="0"
                    >
                    <form action="{{ route('front_candidate_login') }}" method="post">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <a
                                href="{{ route('front_candidate_Forget_password') }}"
                                class="primary-color"
                                >Forget Password?</a
                            >
                        </div>
                    ...
                    <form action="{{ route('company_login') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <a
                                href="{{ route('front_Forget_password') }}"
                                class="primary-color"
                                >Forget Password?</a
                            >
                        </div>
                ...
                <div class="mb-3">
                    <a href="{{ route('front_signup') }}" class="primary-color"
