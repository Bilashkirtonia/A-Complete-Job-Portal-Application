                                    ...
                                    <div class="tab-pane fade" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-4-tab" tabindex="0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    <label class="form-label">Meta Description</label>
                                                    <textarea name="job_listing_page_meta_description" class="form-control h_100" cols="30" rows="10">{{ $page_other_data->job_listing_page_meta_description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-5" role="tabpanel" aria-labelledby="v-pills-5-tab" tabindex="0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    <label class="form-label">Meta Description</label>
                                                    <textarea name="company_listing_page_meta_description" class="form-control h_100" cols="30" rows="10">{{ $page_other_data->company_listing_page_meta_description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
