        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('home_page_content_update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <textarea name="text" name="text" class="form-control h_100" cols="30" rows="10">{{ $page_home_data->text }}</textarea>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" class="form-control" name="job_search" value="{{ $page_home_data->job_search }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-4">
                                                    ...
                                                    <div>
                                                        <img src="{{ asset('uploads/'.$page_home_data->image) }}" alt="" class="w_300">
                                                    </div>
                                                </div>
                                                <div class="mb-4">
