...
class AdminCompanySizeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.company_size.company_size', compact('company_sizes'));
    }

    public function create()
    {
        return view('admin.company_size.company_size_create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.company_size.company_size_edit',compact('company_size_single'));
    }
