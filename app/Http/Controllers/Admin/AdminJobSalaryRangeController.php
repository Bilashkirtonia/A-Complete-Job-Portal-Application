...
class AdminJobSalaryRangeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.salary.job_salary_range', compact('job_salary_ranges'));
    }

    public function create()
    {
        return view('admin.salary.job_salary_range_create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.salary.job_salary_range_edit',compact('job_salary_range_single'));
    }
