...
class AdminCompanyLocationController extends Controller
{
    public function index()
    {
        ...
        return view('admin.companies_location.company_location', compact('company_locations'));
    }

    public function create()
    {
        return view('admin.companies_location.company_location_create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.companies_location.company_location_edit',compact('company_location_single'));
    }
