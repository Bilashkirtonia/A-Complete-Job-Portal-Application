...
class AdminJobGenderController extends Controller
{
    public function index()
    {
        ...
        return view('admin.gender.job_gender', compact('job_genders'));
    }

    public function create()
    {
        return view('admin.gender.job_gender_create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.gender.job_gender_edit',compact('job_gender_single'));
    }
