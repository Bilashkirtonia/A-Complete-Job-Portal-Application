...
class AdminJobLocationController extends Controller
{
    public function index()
    {
        ...
        return view('admin.location.job_location', compact('job_locations'));
    }

    public function create()
    {
        return view('admin.location.job_location_create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.location.job_location_edit',compact('job_location_single'));
    }
