...
class AdminCompanyIndustryController extends Controller
{
    public function index()
    {
        ...
        return view('admin.company_industry.company_industry', compact('company_industries'));
    }

    public function create()
    {
        return view('admin.company_industry.company_industry_create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.company_industry.company_industry_edit',compact('company_industry_single'));
    }
