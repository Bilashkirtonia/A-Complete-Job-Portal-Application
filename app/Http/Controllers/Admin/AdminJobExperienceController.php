...
class AdminJobExperienceController extends Controller
{
    public function index()
    {
        ...
        return view('admin.experence.job_experience', compact('job_experiences'));
    }

    public function create()
    {
        return view('admin.experence.job_experience_create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.experence.job_experience_edit',compact('job_experience_single'));
    }
