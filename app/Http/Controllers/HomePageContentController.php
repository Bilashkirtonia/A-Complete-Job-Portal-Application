...
class HomePageContentController extends Controller
{
    public function home_page_content(){
     $page_home_data = HomePageContentUpdate::where('id','1')->first();
        return view('admin.home_page_content',compact('page_home_data'));

    }



    public function home_page_content_update(Request $request){
        ...
        if($request->hasFile('image')) {
            ...
            @unlink(public_path('uploads/'.$page_home_data->image));
            ...
            $page_home_data->image = $final_name;
        }
        ...
        $page_home_data->job_search = $request->job_search;
