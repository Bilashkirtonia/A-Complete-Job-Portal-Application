...
class CompanyController extends Controller
{
    ...
    public function make_payment(){
        ...
        $current_active = Order::where('company_id',Auth::guard('company')->user()->id)->where('currently_active',1)->first();

        $packages = Package::all();

        return view('company.make_payment',compact('current_active','packages'));
    }
    ...
    {
        $orders = Order::orderBy('id', 'desc')->where('company_id',Auth::guard('company')->user()->id)->get();
        return view('company.orders', compact('orders'));
    }

    public function company_profile_edit(){
        $data['company_locations'] = CompanyLocation::orderBy('name','asc')->get();
        $data['company_industries'] = CompanyIndustry::orderBy('name','asc')->get();
        $data['company_sizes'] = CompanySize::orderBy('name','asc')->get();

        return view('company.company_dashboard_edit',$data);
    }
    ...
    public function edit_profile_update(Request $request){
        ...
        return redirect()->route('company_profile_edit')->with('success', 'Profile is updated successfully.');
    ...
    public function jobs_create()
    {
        ...
        $job_categories = Job_category::orderBy('name','asc')->get();
